...
import { TrainerObj } from '../src/types'
...
class User extends Model<TrainerObj, BaseUserCreationAttributes> implements BaseUserAttributes {
  public id!: number
  public name!: string
  public email!: string
...
interface TrainerCreationAttributes extends Optional<TrainerObj, 'id'> {}

class Trainer extends Model<TrainerObj, TrainerCreationAttributes> implements TrainerObj {
  public id!: number
  public name!: string
  public email!: string
  public password!: string
